...
time_taken <- system.time(for (b in 1:B) {
  print(b)
...
time_taken/60/60 #1 hour

#1 hour for fitting the real data  50 minutes  for fitting the simulated data,
#processor: 2.3 GHz 8-Core Intel Core i9
#RAM: 32GB 2667 MHz DDR4
#operating system: macOS Version 14.4.1 (23E224)
